...
Outputs go to `runs/Exp-09/saliency_validation/`.
"""
...
SEED_IMAGES: list[tuple[str, Path]] = [
    (
        "great_white_shark",
        REPO / "runs/Exp-09/exp09_M0_n16383_shark_seed_5_1776512034/origin.png",
    ),
    (
        "junco_A",
        REPO / "runs/Exp-09/exp09_M0_n16383_junco_chickadee_seed_83_1776533531/origin.png",
    ),
    (
        "junco_B",
        REPO / "runs/Exp-09/exp09_M0_n16383_junco_leatherback_seed_85_1776540489/origin.png",
    ),
    (
        "stingray",
        REPO / "runs/Exp-09/exp09_M0_n16383_stingray_eray_seed_40_1776547325/origin.png",
    ),
]

OUT_DIR = REPO / "runs/Exp-09/saliency_validation"

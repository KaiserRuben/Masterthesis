...
Usage:
    python experiments/generate_seeds_only.py configs/boundary_test.yaml
    python experiments/generate_seeds_only.py configs/pdq_template.yaml --device cuda
    python experiments/generate_seeds_only.py configs/boundary_test.yaml --out seeds/exp05
"""
